...
const labMenuItems: SidebarItem[] = [
  {
    title: 'Dashboard',
    href: '/lab',
            ...
            <SidebarMenuButton size="lg" asChild>
              <Link href="/lab">
                ...
                <div className="flex flex-col gap-0.5 leading-none">
                  <span className="font-bold text-base tracking-tight text-purple-900 dark:text-purple-100">MediTrack Pro</span>
                  <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Lab Portal</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
                 ...
                 <SidebarMenuItem key={item.href}>
                   <SidebarMenuButton 
                     ...
                     className={cn(
                       ...
                       isActive 
                          ? "bg-purple-50 text-purple-700 shadow-sm dark:bg-purple-900/20 dark:text-purple-300 font-semibold" 
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        <div className="grid flex-1 text-left text-sm leading-tight">
                            ...
                            <span className="truncate text-xs text-purple-600 font-medium">Lab Tech</span>
                        </div>
