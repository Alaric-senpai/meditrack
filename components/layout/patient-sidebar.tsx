            ...
            <SidebarMenuButton size="lg" asChild>
              <Link href="/patient">
                ...
                <div className="flex flex-col gap-0.5 leading-none">
                  <span className="font-bold text-base tracking-tight text-teal-900 dark:text-teal-100">MediTrack Pro</span>
                  <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Patient Portal</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
                 ...
                 <SidebarMenuItem key={item.href}>
                   <SidebarMenuButton 
                     ...
                     className={cn(
                       ...
                       isActive 
                          ? "bg-teal-50 text-teal-700 shadow-sm dark:bg-teal-900/20 dark:text-teal-300 font-semibold" 
